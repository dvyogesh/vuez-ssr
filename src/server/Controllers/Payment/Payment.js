...
router.get('/', (req, res, next) => {
	...
	params['CUST_ID'] 			= 'Customer001';
	params['TXN_AMOUNT']			= '1.00';
	params['CALLBACK_URL']		= 'http://localhost:'+port+'/api/payment/callback';
	params['EMAIL']				= 'yogesh.macet@gmail.com';
	params['MOBILE_NO']			= '9490424270';
